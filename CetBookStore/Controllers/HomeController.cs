...
namespace CetBookStore.Controllers
{
    public class HomeController : Controller
    {
          ...
          public async Task<IActionResult> Search()
        {
            ...
            string txtkategori = url.Substring(url.IndexOf('&')+1);
            string txtsearch = url.Substring(0,url.IndexOf('&'));

            string searchtext = txtsearch.Substring(txtsearch.IndexOf('=')+1);
            string categoryID = txtkategori.Substring(txtkategori.IndexOf('=') + 1);
            ...
            else if (searchtext != "")
            {
                ...
                if (categoryID != "")
                {
                    searchModel.CategoryId = int.Parse(categoryID.ToString());
                }
